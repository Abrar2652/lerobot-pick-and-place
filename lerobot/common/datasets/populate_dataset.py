...
from lerobot.common.datasets.push_dataset_to_hub.aloha_hdf5_format import to_hf_dataset as to_hf_dataset_act
from lerobot.common.datasets.push_dataset_to_hub.pusht_zarr_format import to_hf_dataset as to_hf_dataset_diffusion
...
def from_dataset_to_lerobot_dataset(dataset, play_sounds, target_policy):
    ...
    if target_policy == 'diffusion':
        hf_dataset = to_hf_dataset_diffusion(data_dict, video)
    elif target_policy == 'act':
        hf_dataset = to_hf_dataset_act(data_dict, video)
    else:
...
def create_lerobot_dataset(
    ...
    lerobot_dataset = from_dataset_to_lerobot_dataset(dataset, play_sounds, target_policy)
